...
namespace DataLibrary.Repositorys
{
    /// <summary>
    ...
    {
        protected readonly DbWPFContext _dbContext;
        ...
        public Repository(DbWPFContext dbContext)
        {
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous insert operation.</returns>
        public virtual async Task<int> InsertAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
